...
const manifest = [{"module":"@repo/spacetraders-api","exactMatch":"libs/spacetraders-api/src/index.js","pattern":"libs/spacetraders-api/src/index.ts"}];
...
module.exports = require('./apps/agent/src/main.js');
